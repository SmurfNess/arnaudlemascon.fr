...
echo '          <div class="web">https://arnaudlemascon.fr</div>';
  ...
  foreach ($positions as $position) {
    ...
    private function generateEducationCards() {
        ...
        foreach ($educations as $education) {
            ...
            echo '<span class="separator" >|</span><div class="duration" style="display:inline-block; vertical-align: top;">' . $startDate->format('d-m-Y') . ' - ' . $endDate->format('d-m-Y') . '</div>';
            echo '</div>';
            echo '</div>';
            echo '</span>';
        }
