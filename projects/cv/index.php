  ...
  foreach ($positions as $position) {
    ...
    private function generateEducationCards() {
        ...
        foreach ($educations as $education) {
            ...
            echo '<div class="degree"style="display:inline-block">' . $education['title'] . '<span class="school"> <span>-</span> ' . $education['school'] . ' - ' . $education['city'] . '</div></div><span class="separator" >|</span><div class="duration" style="display:inline-block">' . $startDate->format('d-m-Y') . ' - ' . $endDate->format('d-m-Y') . '</div>';
            echo '';
            echo '</div>';
            echo '</span>';
        }
