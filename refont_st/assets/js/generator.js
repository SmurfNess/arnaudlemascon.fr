document.addEventListener('DOMContentLoaded', function () {
    ...
    function updatePositions(positionsData) {
        ...
        function calculateDuration(beginningDate, endingDate) {
            ...
            const end = endingDate === "Present" ? new Date() : new Date(endingDate);
        ...
        // Mettre à jour la div avec la durée de la dernière position sans date de fin
        if (lastPositionDuration) {
            document.getElementById('CURRENT').textContent = lastPositionDuration;
        }
    }
